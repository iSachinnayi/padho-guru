      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text('नाम, कक्षा, बोर्ड',
          ...
          ListTile(
            ...
            title:
                const Text('सब्सक्रिप्शन', style: TextStyle(fontSize: 15)),
            subtitle: const Text('फ्री प्लान • ₹99/महीना',
                style: TextStyle(fontSize: 12)),
            trailing: const Icon(Icons.chevron_right, color: AppTheme.textHint),
            onTap: () {},
          ),
          ...
          SwitchListTile(
            ...
            subtitle: const Text('प्रमोशनल नोटिफिकेशन',
                style: TextStyle(fontSize: 12)),
          ...
          SwitchListTile(
            ...
            title:
                const Text('स्ट्रीक रिमाइंडर', style: TextStyle(fontSize: 15)),
            subtitle: const Text('रोजाना पढ़ाई की याद दिलाएं',
                style: TextStyle(fontSize: 12)),
          ...
          SwitchListTile(
            ...
            title:
                const Text('डार्क मोड', style: TextStyle(fontSize: 15)),
            subtitle: const Text('सिस्टम सेटिंग्स को ओवरराइड करें',
                style: TextStyle(fontSize: 12)),
            value: _darkMode,
          ...
          ListTile(
            ...
            title: const Text('नियम व शर्तें',
                style: TextStyle(fontSize: 15)),
            trailing: const Icon(Icons.chevron_right, color: AppTheme.textHint),
            onTap: () {},
          ),
